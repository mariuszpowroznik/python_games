...
class Block():
	...
	def __init__(self, board):
		self.blocks = [BlockType.BLOCK_I, BlockType.BLOCK_T, BlockType.BLOCK_Z, BlockType.BLOCK_S, BlockType.BLOCK_O, BlockType.BLOCK_L, BlockType.BLOCK_LL]
		#self.blocks = [BlockType.BLOCK_L]
		self.colors = ["black", "red", "green", "blue", "cyan", "yellow", "magenta"]

		self.rot = [[],[],[],[],[],[],[],[]]
		self.rot[BlockType.BLOCK_I.value].append([{"x":0, "y":0},{"x":1, "y":0},{"x":2, "y":0},{"x":3, "y":0}])
		self.rot[BlockType.BLOCK_I.value].append([{"x":0, "y":0},{"x":0, "y":-1},{"x":0, "y":-2},{"x":0, "y":-3}])
		self.rot[BlockType.BLOCK_T.value].append([{"x":0, "y":0},{"x":1, "y":0},{"x":2, "y":0},{"x":1, "y":-1}])
		self.rot[BlockType.BLOCK_T.value].append([{"x":1, "y":0},{"x":1, "y":-1},{"x":1, "y":-2},{"x":0, "y":-1}])
		self.rot[BlockType.BLOCK_T.value].append([{"x":0, "y":-1},{"x":1, "y":-1},{"x":2, "y":-1},{"x":1, "y":0}])
		self.rot[BlockType.BLOCK_T.value].append([{"x":0, "y":0},{"x":0, "y":-1},{"x":0, "y":-2},{"x":1, "y":-1}])
		self.rot[BlockType.BLOCK_Z.value].append([{"x":0, "y":-1},{"x":1, "y":-1},{"x":1, "y":0},{"x":2, "y":0}])
		self.rot[BlockType.BLOCK_Z.value].append([{"x":0, "y":0},{"x":0, "y":-1},{"x":1, "y":-1},{"x":1, "y":-2}])
		self.rot[BlockType.BLOCK_S.value].append([{"x":0, "y":0},{"x":1, "y":0},{"x":1, "y":-1},{"x":2, "y":-1}])
		self.rot[BlockType.BLOCK_S.value].append([{"x":0, "y":-2},{"x":0, "y":-1},{"x":1, "y":-1},{"x":1, "y":0}])
		self.rot[BlockType.BLOCK_O.value].append([{"x":0, "y":0},{"x":1, "y":0},{"x":0, "y":-1},{"x":1, "y":-1}])
		self.rot[BlockType.BLOCK_L.value].append([{"x":0, "y":0},{"x":1, "y":0},{"x":2, "y":0},{"x":2, "y":-1}])
		self.rot[BlockType.BLOCK_L.value].append([{"x":0, "y":-2},{"x":1, "y":-2},{"x":1, "y":-1},{"x":1, "y":0}])
		self.rot[BlockType.BLOCK_L.value].append([{"x":0, "y":0},{"x":0, "y":-1},{"x":1, "y":-1},{"x":2, "y":-1}])
		self.rot[BlockType.BLOCK_L.value].append([{"x":0, "y":-2},{"x":0, "y":-1},{"x":0, "y":0},{"x":1, "y":0}])
		self.rot[BlockType.BLOCK_LL.value].append([{"x":0, "y":-1},{"x":0, "y":0},{"x":1, "y":0},{"x":2, "y":0}])
		self.rot[BlockType.BLOCK_LL.value].append([{"x":0, "y":0},{"x":1, "y":0},{"x":1, "y":-1},{"x":1, "y":-2}])
		self.rot[BlockType.BLOCK_LL.value].append([{"x":0, "y":-1},{"x":1, "y":-1},{"x":2, "y":-1},{"x":2, "y":0}])
		self.rot[BlockType.BLOCK_LL.value].append([{"x":0, "y":0},{"x":0, "y":-1},{"x":0, "y":-2},{"x":1, "y":-2}])
...
class App:
	def __init__(self):
		self.wnd = Tk()
		self.title = Label(self.wnd, text="Tetris game...", fg="green", font=("Helvetica", 16)).grid(row=0)
